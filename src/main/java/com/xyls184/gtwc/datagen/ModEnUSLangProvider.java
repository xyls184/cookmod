...
public class ModEnUSLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("itemGroup.gtwc.vegetables", "Vegetables");
        add("itemGroup.gtwc.vegetable_derivatives", "Vegetable Derivatives");
            ...
            if ("vegetables".equals(food.getTabGroup())) {
                ...
                for (ProcessType type : ProcessType.values()) {
                    ...
                    if (regObj != null) {
                        ...
                        String autoEnName = type.generateEnName(food.getEnName());
                        add(regObj.get(), autoEnName);
                    }
                }
            }
        }
